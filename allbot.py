...
class Allbot:
    ...
    @staticmethod
    def translate_joint_angles(data):
        if data < Allbot.min_joint_input:
            data = Allbot.min_joint_input
        elif data > Allbot.max_joint_input:
            data = Allbot.max_joint_input

        # return int(Allbot.joint_angle_translate_fn(data))
        # return int(Allbot.joint_angle_translate_fn(data))
